...
#define INCLUDE "-I/usr/include/mariadb -I/usr/include/mariadb/mysql"
#define LIBS    " -lmariadb"
#define LIBS_SYS "-ldl -lm -lpthread -lssl -lcrypto"
#define CFLAGS  INCLUDE
#define VERSION "10.4.3"
#define CC_VERSION "3.1.9"
#define PLUGIN_DIR "/usr/lib64/mariadb/plugin"
#define SOCKET  "/tmp/mysql.sock"
#define PORT "3306"
#define TLS_LIBRARY_VERSION "OpenSSL 1.0.1e"
